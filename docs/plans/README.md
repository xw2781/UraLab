...
| [manual_input_stored_length_resq_alignment.md](manual_input_stored_length_resq_alignment.md) | ResQ's stored-length and coarse-paste rules established against its API (2026-09-06); broken into 7 session-sized steps, 3 done (2026-09-06). |
