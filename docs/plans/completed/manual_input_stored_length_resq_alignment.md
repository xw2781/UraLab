...
| 7 | The server components carry the change | [x] | 2026-09-07 | Saving from a shared project now uses the new behaviour too, so a yearly view over monthly figures keeps them when the save is done on the server; the Data tab part of it arrives with the next app build. |

Overall: 7 of 7 steps done.
